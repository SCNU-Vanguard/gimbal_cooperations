...
void gimbal_PID_init()//角度环和速度环的PID初始化,只是初测出来的数据，具体还需要测试
{
	...
	pid_init(&gimbal_yaw_angle_pid, 10000, 0.001, 0,100, 1000);//P=500,I=0,D=1
  pid_init(&gimbal_yaw_speed_pid_return, 4,0.002,0.001, 1000, 1000);//P=30,I=0,D=0`
  pid_init(&gimbal_yaw_angle_pid_return, 12000,0.001,0,100, 1000);//P=500,I=0,D=1
}
